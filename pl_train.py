...
class CustomDataset(pl.LightningDataModule):
    ...
    def _setup(self):
        ...
        # print(ds_length)
        # print(int(ds_length * 0.8))
        # Split the dataset into train and validation datasets
        self.tr_ds, self.val_ds, self.test_ds = torch.utils.data.random_split(self.ds, [int(ds_length * 0.8), int(ds_length * 0.1), int(ds_length * 0.1)])
...
def run(args):
    ...
    wandb_logger = WandbLogger(project='classification', job_type='train')
